...
export const destinations: DeepReadonlyArray<Destination> = [
  {
    name: 'Moon',
    images: {
...
export const crew: DeepReadonlyArray<CrewMember> = [
  {
    name: 'Douglas Hurley',
    images: {
...
export const technologies: DeepReadonlyArray<Technology> = [
  {
    name: 'Launch vehicle',
    images: {
